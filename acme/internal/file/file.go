/*
 * Structure of Undo list: The Undo structure follows any associated data, so
 * the list can be read backwards: read the structure, then read whatever data
 * is associated (insert string, file name) and precedes it.  The structure
 * includes the previous value of the modify bit and a sequence number;
 * successive Undo structures with the same sequence number represent
...
import (
	...
	"bwsd.dev/plan9/acme/internal/disk"
